...
import lintfordpickle.mailtrain.data.scene.environment.SceneProps;
...
public class SceneryController extends BaseController implements IInputProcessor {
	...
	private SceneProps mWorldScenery;
	...
	public SceneProps worldScenery() {
	...
	public SceneryController(ControllerManager pControllerManager, SceneProps pWorldScenery, int pEntityGroupUid) {
